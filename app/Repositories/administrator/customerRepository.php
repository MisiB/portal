...
public function show($id){
    ...
    if(count($usd_nonrefundable_accountnumber)>0)
      ...
      {
          // Log::info($zwl_nonrefundable_accountnumber);
       for ($i=0; $i < count($zwl_nonrefundable_accountnumber); $i++) { 

          
             $balance = $suspense->getBalance($company,$zwl_nonrefundable_accountnumber[$i]['accountnumber']);
             $zwl_nonrefundable_balance = $zwl_nonrefundable_balance+ $balance;
       }
      ...
      {
        Log::info($zwl_refundable_accountnumber);
