...
<div style="width:725px; height:920px;  text-align:center; border: 1px solid #787878">
     ...
     <span style="font-size:20px">Verification Code: <b>{{$supplier->code}}</b></span><br/><br/>
       <span style="font-size:18px"><b><i>Please note that the authenticity and validity of this certificate must be verified on our PRAZ portal at http://portal.praz.org.zw</i></b></span><br>
      
       <span style="font-size:30px"><img src="./img/code.jpg"></span> 
