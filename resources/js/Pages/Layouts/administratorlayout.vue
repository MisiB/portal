<template>
    <v-app id="inspire">
        ...
        <v-app-bar app clipped-left flat fixed color="white" light height="100">
            ...
            >
                ...
                <v-list>
                    <v-list-item>
                        <inertia-link class="v-list-item theme--light" :href="$route('changepassword.index')">Change Password</inertia-link>
                    </v-list-item>
                    <v-list-item>
        ...
        <v-list>
              <inertia-link class="v-list-item v-list-item--link theme--light  pt-1 pb-1 pl-2 pr-0 d-flex" :href="$route('admin.home')">
                   <v-icon class="text-color">mdi-view-dashboard</v-icon><div class="ml-2 text-color font-weight-thin"> Dashboard</div>
             </inertia-link>            
    ...
    >
      <template v-slot:activator="{ on, attrs }">
          ...
          v-on="on">
          <v-icon v-text="module.icon" class="text-color"></v-icon>
          <div class="ml-2 text-color font-weight-thin">{{module.name}}</div>
          </div>                  
           <v-divider/>
      </template>
